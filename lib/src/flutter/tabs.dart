...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /**--------修改处一：保留原来的字体大小，避免使用默认的字体动画------------------**/
    defaultStyle = defaultStyle.copyWith(fontSize: defaultUnselectedStyle.fontSize);
    /**--------修改处一：保留原来的字体大小，避免使用默认的字体动画end----------------**/
    ...
    return DefaultTextStyle(
      ...
      child: IconTheme.merge(
        ...
        // child: child,
        /**--------修改处二：使用scale动画处理字体大小变化-------------------------**/
        child: Transform.scale(scale: scale,child: child,),
        /**--------修改处二：使用scale动画处理字体大小变化--------end---------------**/
      ),
    );
  }
}
